/**
 * @file main.cpp
 * @brief Program testowy dla klasy matrix
 *
 * Program przeprowadza kompletny zestaw testów funkcjonalności klasy matrix,
 * obejmujący konstruktory, operatory, metody transformacji i wypełniania.
 */
 ...
 * - Testy konstruktorów (domyślny, parametryczny, z tablicą, kopiujący)
 * - Testy metod dostępu (wstaw, pokaz, at)
 * - Testy transformacji (odwroc, losuj, szachownica)
 * - Testy wzorów (przekatna, pod_przekatna, nad_przekatna)
 * - Testy operacji diagonalnych (diagonalna, diagonalna_k)
 ...
 *
 * @return 0 jeśli wszystkie testy zakończą się sukcesem, 1 w przypadku błędu
 */
int main() {
    ...
    try {
        ...
        cout << "=== TEST 2: KONSTRUKTOR Z TABLICA ===" << endl;
        int tab[] = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
        matrix m2(3, tab);
        cout << "Macierz m2 (3x3) - inicjalizacja tablica:" << endl;
        cout << m2 << endl;

        // Test 3: Konstruktor kopiujący
        cout << "=== TEST 3: KONSTRUKTOR KOPIUJACY ===" << endl;
        matrix m3 = m2;
        ...
        cout << "=== TEST 6: OBROCENIE (TRANSPOZYCJA) ===" << endl;
        matrix m_obr = m2;
        m_obr.odwroc();
        cout << "Macierz m2 po obroceniu:" << endl;
        cout << m_obr << endl;
        ...
        // Test 8: Szachownica
        cout << "=== TEST 8: WZOR SZACHOWNICA ===" << endl;
        matrix m_szach(6);
        m_szach.szachownica();
        ...
        // Test 9: Przekątna
        cout << "=== TEST 9: PRZEKATNA ===" << endl;
        matrix m_diag(4);
        m_diag.przekatna();
        cout << "Macierz diagonalna (1 na przekatnej, 0 poza):" << endl;
        cout << m_diag << endl;

        // Test 10: Pod przekątną
        cout << "=== TEST 10: POD PRZEKATNA ===" << endl;
        matrix m_pod(4);
        m_pod.pod_przekatna();
        cout << "Macierz z jedynkami pod przekatna:" << endl;
        cout << m_pod << endl;

        // Test 11: Nad przekątną
        cout << "=== TEST 11: NAD PRZEKATNA ===" << endl;
        matrix m_nad(4);
        m_nad.nad_przekatna();
        cout << "Macierz z jedynkami nad przekatna:" << endl;
        cout << m_nad << endl;
        ...
        cout << "Macierz z danymi na przekatnej:" << endl;
        cout << m_diag_dane << endl;

        // Test 13: Diagonalna przesunięta
        cout << "=== TEST 13: DIAGONALNA PRZESUNIETA ===" << endl;
        matrix m_diag_k(4);
        int dane4[] = { 1, 2, 3 };
        m_diag_k.diagonalna_k(1, dane4);
        cout << "Macierz z danymi na przekatnej przesuniete o 1 do gory:" << endl;
        cout << m_diag_k << endl;
        ...
        cout << "=== TEST 17: MNOZENIE MACIERZY (A*B) ===" << endl;
